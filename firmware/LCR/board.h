...
class Board {
  public:
    ...
    Button up_button{UP_PIN, DEBOUNCE_TIME_MS, BUTTON_AVG_COUNT, BUTTON_HOLD_BLANK, BUTTON_HOLD_DELAY};
    Button down_button{DOWN_PIN, DEBOUNCE_TIME_MS, BUTTON_AVG_COUNT, BUTTON_HOLD_BLANK, BUTTON_HOLD_DELAY};
